      ...
      <div className="grid grid-row-3 ">
        ...
        <div className=" bg-blue-900 p-10">
          <div style={{ marginLeft: '13rem' }} className="flex item-centre space-x-2 ">
            <span className="text-gray-50 font-bold tracking-wider text-4xl">Industry Tools</span>
            <div style={{ marginLeft: '35rem' }} className="flex items-centre space-x-2 ">
              ...
              <span class=" text-xs text-gray-500  font-bold">INDUSTRY TOOLS</span>
            </div>
          </div>
        </div>
