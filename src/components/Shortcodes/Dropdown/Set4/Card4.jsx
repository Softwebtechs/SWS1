...
const Card4 = ({ image, name, position }) => {
    return (
        <>
            <div className="group md:h-[560px] md:w-72 h-[700px] w-[380px] bg-gray-100 hover:shadow-xl relative ">
                <img src={image} alt="img1" class="hover:shadow-xl md:h-[440px] md:w-72 h-[580px] w-[380px]" />

                <div class="bg-white group-hover:opacity-60 absolute inset-0 transition duration-300  opacity-0 lg:max-xl:w-[250px] lg:max-xl:ml-2 md:h-20 md:w-[290px] h-[100px]  md:mt-[360px] mt-[480px]   ">
                ...
                <div class="flex flex-col group-hover:bg-orange-600 group-hover:text-white justify-center items-center h-[120px] md:w-72 w-96">
