...
const Card5 = ({ image, name, position }) => {
    return (
        <>
            <div className="group md:h-[440px] md:w-72 h-[500px] w-[380px] bg-gray-50  ">
                <div class="relative">
                    <img src={image} alt="img2" className="  md:w-72 md:h-72 h-96 w-[380px]  rounded-full " />
                    <div class="border-[20px] rounded-full absolute inset-0 opacity-60 group-hover:border-orange-500 group-hover:opacity-100"></div>
                </div>
                <div className="flex flex-col justify-center items-center visible group-hover:invisible mt-14 gap-2">

                    <h1 class="text-xl font-bold font-poppins">{name}</h1>
                    <p class="text-l  font-poppins">{position}</p>
                </div>
                <div class="invisible group-hover:visible flex flex-row justify-center items-center -mt-16  gap-4">
