...
const Card3 = ({ image, name, position }) => {
    return (
        <>
            <div className="group md:h-[440px] md:w-72 h-[580px] w-[380px] bg-gray-100 hover:shadow-xl relative ">
                ...
                <div class="bg-white group-hover:opacity-60 absolute inset-0 transition duration-300  opacity-0 lg:max-xl:w-[220px] lg:max-xl:ml-2 md:h-[350px] md:w-[280px] h-[480px]  mt-12 ml-4 -rotate-[6deg] ">
                    <div className="flex flex-col justify-center items-center group-hover:opacity-100  rotate-[6deg] absolute inset-0">
