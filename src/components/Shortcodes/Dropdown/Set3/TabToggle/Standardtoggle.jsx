        ...
        <>
            <div className="flex flex-col justify-center items-center md:gap-10 gap-7 font-poppins mt-20">
                <h1 className="md:text-5xl text-3xl w-full font-bold text-orange-500 flex justify-center gap-4 ">
                    STANDARD   <span className="text-blue-950">TOGGLE STYLE</span>
                </h1>
            </div>
            ...
            <div className="md:flex md:flex-row flex flex-col md:px-32 px-7 md:max-xl:px-10 gap-5 mt-5">
                <div className="flex flex-col md:w-1/2 w-full  h-full gap-4 justify-center">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row gap-2">
                            <button className={`bg-gray-200 w-10 h-10 flex justify-center items-center" ${isOpen ? 'bg-orange-500' : ''}`} onClick={toggleParagraph}>
                                {isOpen ? (
                        ...
                        {isOpen && <p className="text-gray-200">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi hendrerit elit turpis, a porttitor tellus sollicitudin at. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>}
                    </div>
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row gap-2">
                            <button className={`bg-gray-200 w-10 h-10 flex justify-center items-center" ${isOpen1 ? 'bg-orange-500' : ''}`} onClick={toggleParagraph1}>
                                {isOpen1 ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white  ">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                    </svg>
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row gap-2">
                            <button className={`bg-gray-200 w-10 h-10 flex justify-center items-center" ${isOpen2 ? 'bg-orange-500' : ''}`} onClick={toggleParagraph2}>
                                {isOpen2 ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white  ">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                    </svg>
                ...
                <div className="flex flex-col md:w-1/2 w-full  h-full gap-4 justify-end items-end">
                    <div className="flex flex-col justify-end items-end gap-2">
                        <div className="flex flex-row gap-2">
                            <p className="text-xl font-semibold text-blue-950">Toggle 1</p>
                            <button className={`bg-gray-200 w-10 h-10 flex justify-center items-center" ${isOpen3 ? 'bg-orange-500' : ''}`} onClick={toggleParagraph3}>
                                {isOpen3 ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white  ">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                    </svg>
                    ...
                    <div className="flex flex-col justify-end items-end gap-2">
                        <div className="flex flex-row gap-2">
                            <p className="text-xl font-semibold text-blue-950">Toggle 2</p>
                            <button className={`bg-gray-200 w-10 h-10 flex justify-center items-center" ${isOpen4 ? 'bg-orange-500' : ''}`} onClick={toggleParagraph4}>
                                {isOpen4 ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white  ">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                    </svg>
                    ...
                    <div className="flex flex-col justify-end items-end gap-2">
                        <div className="flex flex-row gap-2">
                            <p className="text-xl font-semibold text-blue-950">Toggle 3</p>
                            <button className={`bg-gray-200 w-10 h-10 flex justify-center items-center" ${isOpen5 ? 'bg-orange-500' : ''}`} onClick={toggleParagraph5}>
                                {isOpen5 ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white  ">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                    </svg>
