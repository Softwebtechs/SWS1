    ...
    return (
        <button
            style={{
                ...
                borderTop: isActive ? '4px solid orange' : 'none', // Orange border for active tab
                borderBottom: 'none',
            }}
            onClick={onClick}
        >
        ...
        <>
            <div className="flex flex-col justify-center items-center md:gap-10 gap-7 font-poppins mt-20">
                <h1 className="md:text-5xl text-3xl w-full font-bold text-orange-500 flex justify-center gap-4 ">
                    HORIZONTAL TABS <span className="text-blue-950">TYPE 7</span>
                </h1>
            </div>
            <div className="container mx-auto p-4 md:px-44 px-14 md:max-lg:px-10 lg:max-xl:px-20"> {/* Container with border */}
                <div className="flex  text-xl text-gray-500  h-14 bg-gray-200 font-semibold">
                    <Tab
                        title="Tab 1"
                        isActive={activeTab === 'tab1'}
                        onClick={() => openTab('tab1')}
                    />
                    <div class="border  border-gray-700 h-10 mt-2"></div>
                    <Tab
                        title="Tab 2"
