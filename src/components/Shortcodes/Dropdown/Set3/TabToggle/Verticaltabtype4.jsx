        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center md:gap-10 gap-7 font-poppins mt-20">
                <h1 className="md:text-5xl text-3xl w-full font-bold text-orange-500 flex justify-center gap-4 ">
                    VERICAL   <span className="text-blue-950">TABS TYPE 2</span>
                </h1>
            </div>
            <div className="flex flex-row container mx-auto mt-10 md:px-32 ml-0 md:max-lg:px-10  lg:max:xl:px-14 ">
                <div className="flex flex-col gap-4 w-96 h-[200px] text-xl text-gray-500  font-semibold hover:text-orange-500">
                    <Tab
                        title="Tab 1"
                        ...
                        className=""
                    />
                    <div className="border w-40 border-gray-200 ml-32 "></div>
                    <Tab
                        title="Tab 2"
                ...
                <div className=" ml-10  w-full ">
                    <TabContent isActive={activeTab === 'tab1'}>
                        <div class="flex flex-col gap-7">
                            <h1 class="text-4xl font-bold font-poppins">Himenaeos Porttitor</h1>
...
export default Verticaltabtype4;
