    ...
    return (
        <>
            ...
            <div className="flex flex-row container mx-auto mt-10 md:px-32 ml-0 md:max-lg:px-10  lg:max:xl:px-14 ">
                <div className="flex flex-col gap-4 w-96 h-[200px] text-xl text-gray-500 bg-gray-200 font-semibold hover:text-orange-500">
                    <Tab
                        title="Tab 1"
...
export default Verticaltabtype1;
