...
const ProgressBar = ({ value, maxValue, color }) => {
    ...
    return (
        <div className="relative pt-1">
            <div className={`overflow-hidden h-1 mb-4 text-xs flex rounded bg-white border`}>
                <div
            ...
            <div className="absolute mt-3 top-0 left-0 right-5 text-center text-sm text-white font-semibold bg-black w-8 h-7" style={{ left: `${labelPosition}%` }}>{value}%</div>
        </div>
    );
};
            ...
            <div className="md:flex md:flex-row flex flex-col gap-5 w-full h-full md:px-40 px-10 ">
                <div className="flex flex-col gap-4 md:w-1/2 w-full h-full">
                    <div className="container mx-auto px-4">
                        <h1 className="text-l  font-semibold mt-8 font-poppins">Wordpress</h1>
                        <ProgressBar value={value1} maxValue={100} color="bg-yellow-500" />
                    </div>

                    <div className="container mx-auto ">
                        <h1 className="text-l font-semibold w-40 font-poppins ">CREATIVE TEAM</h1>
                        <ProgressBar value={value2} maxValue={100} color="bg-blue-500" />
                    </div>
                    <div className="container mx-auto ">
                        <h1 className="text-l font-semibold w-40 font-poppins ">PHP</h1>
                        <ProgressBar value={value3} maxValue={100} color="bg-blue-500" />
                    </div>
                    <div className="container mx-auto ">
                        <h1 className="text-l font-semibold w-40 font-poppins ">Development</h1>
                        <ProgressBar value={value4} maxValue={100} color="bg-blue-500" />
                    </div>
                ...
                <div className="flex flex-col gap-4 md:w-1/2 w-full h-full">
                    <div className="container mx-auto px-4">
                        <h1 className="text-l  font-semibold mt-8 font-poppins">Print Design</h1>
                        <ProgressBar value={value1} maxValue={100} color="bg-yellow-500" />
                    </div>

                    <div className="container mx-auto ">
                        <h1 className="text-l font-semibold w-40 font-poppins ">Html5 / CSS3</h1>
                        <ProgressBar value={value2} maxValue={100} color="bg-blue-500" />
                    </div>
                    <div className="container mx-auto ">
                        <h1 className="text-l font-semibold w-40 font-poppins ">BigCommerce</h1>
                        <ProgressBar value={value3} maxValue={100} color="bg-blue-500" />
                    </div>
                    <div className="container mx-auto ">
                        <h1 className="text-l font-semibold w-40 font-poppins ">Programmers</h1>
                        <ProgressBar value={value4} maxValue={100} color="bg-blue-500" />
                    </div>
