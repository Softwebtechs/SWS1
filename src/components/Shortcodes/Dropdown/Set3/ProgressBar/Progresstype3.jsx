    ...
    return (
        <div className="relative pt-1">
            <div className="text-right">
                <span className="text-l font-semibold inline-block text-gray-600">
                    {defaultValue}%
                </span>
            </div>
            <div className="overflow-hidden h-2.5 mb-4 text-xs flex  bg-white border border-black relative">
                <div
                    style={{ width: `${progressWidth}%` }}
                    className={`p-2 shadow-none flex flex-col whitespace-nowrap justify-center transition-all duration-500 ease-in-out ${color}`}
                ></div>
                <div className="ml-2 mr-2 text-gray-500 font-semibold"></div>
            </div>
        </div>
    );
};
        ...
        <>
            <div className="flex flex-col justify-center items-center md:gap-10 gap-7 font-poppins mt-20">
                <h1 className="md:text-5xl text-3xl w-full font-bold text-orange-500 flex justify-center gap-4 ">
                    PROGRESS BAR   <span className="text-blue-950">3</span>
                </h1>
            </div>
            <div className="md:flex md:flex-row flex flex-col w-full h-full md:px-40 px-10 ">
                <div className="flex flex-col gap-4 md:w-1/2 w-full h-full">
                    <div className="container mx-auto px-4">
                        <h1 className="text-l text-gray-500 font-semibold mt-8 font-poppins">Wordpress</h1>
                        <ProgressBar defaultValue={90} maxValue={100} color="bg-pink-700" />
                    </div>
                    <div className="container mx-auto px-4">
                        <h1 className="text-l text-gray-500 font-semibold  font-poppins">Html5 / CSS3</h1>
                        <ProgressBar defaultValue={85} maxValue={100} color="bg-purple-900" />
                    </div>
                    <div className="container mx-auto px-4">
                        <h1 className="text-l text-gray-500 font-semibold  font-poppins">BigCommerce</h1>
                        <ProgressBar defaultValue={75} maxValue={100} color="bg-blue-500" />
                    </div>
                    <div className="container mx-auto px-4">
                        <h1 className="text-l text-gray-500 font-semibold  font-poppins">Programmers</h1>
                        <ProgressBar defaultValue={90} maxValue={100} color="bg-rose-600" />
                    </div>
                </div>
                <div className="flex flex-col gap-4 md:w-1/2 w-full h-full">
                    <div className="container mx-auto px-4">
                        <h1 className="text-l text-gray-500 font-semibold mt-8 font-poppins">Print Design</h1>
