...
const Counter = ({ initialValue }) => {
    ...
    return (
        <span className="flex tabular-nums text-black text-5xl font-bold mb-2">
...
const CounterBlock = ({ initialValue, label, icon }) => {
    return (
        <div className="group flex flex-col  gap-4  h-56 w-full md:w-72 lg:max-xl:w-96 justify-center items-center">
            ...
            <div className="group-hover:visible invisible flex justify-center items-center absolute -mt-14">
                {icon}
            </div>
            <div class="group-hover:invisible visible">
                <Counter initialValue={initialValue} />
            </div>
            <span className="inline-flex  text-center text-l">{label}</span>
            <div className="border-2 border-black w-10  group-hover:border-orange-500 mt-3"></div>
...
const Countertype5 = () => {
    const iconStyle = { fontSize: "70px", color: "black" };
    return (
        <>
            <div className="flex flex-col justify-center items-center  md:gap-10 gap-7  font-poppins m">

                <h1 className="md:text-5xl text-3xl w-full  font-bold text-orange-500 flex justify-center gap-4 " >Number Counter  <span className="text-blue-950">Type 5</span></h1>
            </div>
            ...
            <div className=" xl:flex xl:flex-row flex flex-col gap-4  sm:px-44 px-24 py-10 lg:max-xl:px-56 md:max-lg:mt-80 ">
                ...
                <div class="xl:flex xl:flex-row lg:max-xl:flex lg:max-xl:flex-row md:max-lg:flex md:max-lg:flex-row flex flex-col gap-2">
                    ...
                    <CounterBlock initialValue="150" label=" SINGER" icon={<SvgIcon component={LocalSeeIcon} style={iconStyle} />} />
                </div>
