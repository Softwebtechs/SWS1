    ...
    <>
      <div className="flex h-screen bg-white justify-center  mt-10">
        <div className="md:flex md:flex-row flex-col gap-4">
          ...
          <div className="m-8 bg-white p-8 drop-shadow-xl h-auto">
            ...
            <form>
              ...
              <button
                type="submit"
                className="bg-blue-900 hover:bg-blue-700 text-white font-normal py-2 px-11 focus:outline-none focus:shadow-outline"
              >
                Send Message
              </button>
            </form>
