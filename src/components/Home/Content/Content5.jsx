    ...
    <>
      <div className="flex flex-col justify-center items-center mb-20">
        ...
        <div className="flex flex-row">
          <div className="h-72 w-48 bg-gray-400 flex items-end m-5">
            <div className="bg-white gap-2 h-28 w-48 flex flex-col justify-center items-center shadow-[rgba(0,0,0,0.3)_0px_2px_0px_0px]">
          ...
          <div className="h-72 w-48 bg-gray-400 flex items-end m-5">
            <div className="bg-white h-28 w-48 flex flex-col justify-center items-center gap-2 shadow-[rgba(0,0,0,0.3)_0px_2px_0px_0px]">
